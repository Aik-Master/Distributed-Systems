...
/**
 * verkehrschaos/StreetsPOA.java . Generated by the IDL-to-Java compiler (portable), version "3.2" from verkehrschaos.idl Samstag, 4. April 2015 19:41 Uhr MESZ
 */

public abstract class StreetsPOA extends org.omg.PortableServer.Servant implements verkehrschaos.StreetsOperations, org.omg.CORBA.portable.InvokeHandler{
    ...
    public Streets _this(){
        return StreetsHelper.narrow(super._this_object());
    }

    public Streets _this(org.omg.CORBA.ORB orb){
        return StreetsHelper.narrow(super._this_object(orb));
    }
